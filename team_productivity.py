...
team_df.loc[(team_df['TeamWork2'] >= 3) &(team_df['TeamWork3'] >= 3) & (team_df['TeamWork4'] >= 3) & (team_df['TeamWork5'] >= 3), 'TeamWork'] = 'Good'
...
team_df.loc[(team_df['TeamWork2'] == 3) &(team_df['TeamWork3'] == 3) & (team_df['TeamWork4'] == 3), 'TeamWork'] = 'Poor'
...
confusionMatrix = pd.crosstab(team_df['Productivity'], team_df['TeamWork'], rownames=['Productivity'], colnames=['TeamWork'])
...
c, p, dof, expected = chi2_contingency(confusionMatrix)
print(c)
print(p)
print(expected)
